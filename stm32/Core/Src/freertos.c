...
/* Definitions for serialRx */
osThreadId_t serialRxHandle;
const osThreadAttr_t serialRx_attributes = {
  .name = "serialRx",
  .stack_size = 512 * 4,
...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of serialRx */
  serialRxHandle = osThreadNew(serialRxTask, NULL, &serialRx_attributes);
...
/**
* @brief Function implementing the serialRx thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_serialRxTask */
__weak void serialRxTask(void *argument)
{
